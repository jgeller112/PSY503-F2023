...
The main text for this course will be the CourseKata book Statistics: A Modeling Approach. This book
is integrated with our Canvas page, so you can access all of the materials there for free. This book has exercise built into every chapter. 
...
While R will be our primary statistics workhorse, it is not a very pretty program. R Studio is a free (and Windows-/Mac-friendly) supplemental program, that dresses R up a bit to make it
