...
7.  The histogram generated from the bb2021 data for the `hr_round` variable appears to be fairly normal. For a more comprehensive view, let's perform bootstrapping on this dataset 10,000 times and examine the resulting histogram.
...
9.  Calculate the mean heart rate for each participant on each trial type. Save it to a new dataframe called `participant_means`.
