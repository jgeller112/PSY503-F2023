...
ggplot(class_tally, aes(x = "Data Analysis", y = perc, fill = Data_Analysis)) +
  ...
  labs(
    title = "Stacked Bar Plot of Data Analysis Categories",
    x = NULL,
    y = "Percentage"
  ) +
...
ggplot(class_tally, aes(x = "Experience Writing Code", y = perc, fill = How.much.experience.do.you.have.writing.code. )) +
  geom_bar(stat = "identity") +
  geom_text(aes(y = perc, label = paste0(round(perc, 1), "%")),
            color = "black",
            size = 16,
...
ggplot(class_tally, aes(x = "Math Code", y = perc, fill = Math )) +
  geom_bar(stat = "identity") +
  geom_text(aes(y = perc, label = paste0(round(perc, 1), "%")),
            color = "black",
            size = 16,
            position = position_stack(vjust = 0.5)) +
  labs(
    title = "Stacked Bar Plot of Math Feelings",
    x = "",
    y = "Percentage"
  ) +
  theme(axis.text.x=element_blank(),
...
ggplot(class_tally, aes(x = "Nervous", y = perc, fill = Nervous )) +
  geom_bar(stat = "identity") +
  geom_text(aes(y = perc, label = paste0(round(perc, 1), "%")),
            color = "black",
            size = 16,
            position = position_stack(vjust = 0.5)) +
  labs(
    title = "Stacked Bar Plot Nervous",
    x = "",
    y = "Percentage"
  ) +
  theme(axis.text.x=element_blank(),
...
ggplot(class_tally, aes(x = "RMD", y = perc, fill = RMD )) +
  geom_bar(stat = "identity") +
  geom_text(aes(y = perc, label = paste0(round(perc, 1), "%")),
            color = "black",
            size = 16,
...
::: {.column width="50%"}
-   R is programming language and environment primarily focused on
...
-   It is your responsibility to dig deeper when you need and / or want
    ...
    -   Graduate studies -- learning to be independent and thinking on
        your own!
