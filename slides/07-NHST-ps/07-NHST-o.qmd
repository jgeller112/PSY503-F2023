...
master %>%
select(CESD_total, PIL_total) %>%
summarize(cov_xy=cov(CESD_total, PIL_total), sd_cesd=sd(CESD_total), sd_pil=sd(PIL_total), r=cov_xy/(sd_cesd*sd_pil))
...
We found a significant neg and large correlation between meaning in life and depression scores--as meaning in life increases depression scores decrease, r =, 95% CI[], p < .001.  
