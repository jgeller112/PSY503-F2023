...
6.  Yesterday the whether forecaster said that there was a 30% chance of
    rain today, and it rained today. Was she right or wrong?
...
-   Random processes are **mechanisms** that produce outcomes... from
    **a world/set of possible** outcomes... with some degree of
    **uncertainty** but with **regularity**
    ...
    -   Think about the following random phenomenon: "randomly selecting
        ...
        -   Sample space?
            ...
            -   One possible outcome:
                $\omega = \{\mathrm{Tyler, \: Stats}\}$

            -   Another possible outcome:
                $\omega = \{\mathrm{Sana, \: Sev}\}$
...
-   DGP to characterize uncertainty/randomness
