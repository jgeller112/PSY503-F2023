---
title: "04-Probablity Distributions and Visualization Notes"
...
```{webr-r}
    ...
    expand.grid(dice_rolls, dice_rolls)
...
```{webr-r}
# cum probablity of cont random var
...
hist(sample(1:6, 200000, replace=TRUE))
...
#| fig-align: center
  ...
  labs(x="Bill Length in milimters", y="Flipper Length in milimeters", title="Title of Figure") + 
  theme_minimal(base_size = 16)
