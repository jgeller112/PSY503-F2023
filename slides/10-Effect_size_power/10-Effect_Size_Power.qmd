...
![](images/Oct. 31 Seminar in Advanced Research Methods Flyer-1.png){fig-align="center"}
...
WebPower::wp.regression(n=NULL, p1=1, p2=0, f2=.26, alpha=.05, power=.8)
```
...
n <- 12
mu <- c(5, 3, 6, 9, 4)
sd <- c(1.65, 1.91, 1.65, 1.91, 1.54)
label_list = list("condition" = c("Smell", "Taste", "Sight", "Touch", "Sound")) #
...
```{r}
plot_power(design_result, min_n = 10, max_n = 250, emm=TRUE)
```
